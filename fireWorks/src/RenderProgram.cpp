...
void RenderProgram::enable(){
	glUseProgram(program);
}

bool RenderProgram::addShader(GLenum shaderType, const char* fileName){
...
GLint RenderProgram::getUniformLocation(const char* uniformName){
...
GLint RenderProgram::getProgramParam(GLint param){
    GLint ret;
